...
export interface DeleteAlarmCollectionResource$Params {
...
export function deleteAlarmCollectionResource(http: HttpClient, rootUrl: string, params?: DeleteAlarmCollectionResource$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteAlarmCollectionResource.PATH, 'delete');
  if (params) {
...
deleteAlarmCollectionResource.PATH = '/alarm/alarms';
