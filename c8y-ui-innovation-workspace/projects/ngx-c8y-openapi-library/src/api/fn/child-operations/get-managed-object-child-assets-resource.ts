...
export interface GetManagedObjectChildAssetsResource$Params {
...
export function getManagedObjectChildAssetsResource(http: HttpClient, rootUrl: string, params: GetManagedObjectChildAssetsResource$Params, context?: HttpContext): Observable<StrictHttpResponse<ManagedObjectReferenceCollection & {
'prev'?: any;
'self'?: any;
'next'?: any;
}>> {
  const rb = new RequestBuilder(rootUrl, getManagedObjectChildAssetsResource.PATH, 'get');
  if (params) {
...
getManagedObjectChildAssetsResource.PATH = '/inventory/managedObjects/{id}/childAssets';
