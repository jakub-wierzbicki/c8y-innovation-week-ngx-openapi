...
export interface GetManagedObjectChildDevicesResource$Params {
...
export function getManagedObjectChildDevicesResource(http: HttpClient, rootUrl: string, params: GetManagedObjectChildDevicesResource$Params, context?: HttpContext): Observable<StrictHttpResponse<ManagedObjectReferenceCollection & {
'prev'?: any;
'self'?: any;
'next'?: any;
}>> {
  const rb = new RequestBuilder(rootUrl, getManagedObjectChildDevicesResource.PATH, 'get');
  if (params) {
...
getManagedObjectChildDevicesResource.PATH = '/inventory/managedObjects/{id}/childDevices';
