...
export interface PutManagedObjectResource$Params {
...
export function putManagedObjectResource(http: HttpClient, rootUrl: string, params: PutManagedObjectResource$Params, context?: HttpContext): Observable<StrictHttpResponse<ManagedObject>> {
  const rb = new RequestBuilder(rootUrl, putManagedObjectResource.PATH, 'put');
  if (params) {
...
putManagedObjectResource.PATH = '/inventory/managedObjects/{id}';
