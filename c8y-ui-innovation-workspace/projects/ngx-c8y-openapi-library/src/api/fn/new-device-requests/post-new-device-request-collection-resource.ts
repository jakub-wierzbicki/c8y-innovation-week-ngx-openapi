...
export interface PostNewDeviceRequestCollectionResource$Params {
...
export function postNewDeviceRequestCollectionResource(http: HttpClient, rootUrl: string, params: PostNewDeviceRequestCollectionResource$Params, context?: HttpContext): Observable<StrictHttpResponse<NewDeviceRequest>> {
  const rb = new RequestBuilder(rootUrl, postNewDeviceRequestCollectionResource.PATH, 'post');
  if (params) {
...
postNewDeviceRequestCollectionResource.PATH = '/devicecontrol/newDeviceRequests';
