...
export interface PutBulkOperationResource$Params {
...
export function putBulkOperationResource(http: HttpClient, rootUrl: string, params: PutBulkOperationResource$Params, context?: HttpContext): Observable<StrictHttpResponse<BulkOperation>> {
  const rb = new RequestBuilder(rootUrl, putBulkOperationResource.PATH, 'put');
  if (params) {
...
putBulkOperationResource.PATH = '/devicecontrol/bulkoperations/{id}';
